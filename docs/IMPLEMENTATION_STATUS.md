...
4. Guided custom-font workflow, controlled template render comparisons and signed expansion packs/online repair. Exact compiler retention, local offline repair and backed-up compiler migration pass their local/native workflows; broader Mac acceptance remains open.
5. Large-archive responsiveness and interrupted-import cleanup UI.
