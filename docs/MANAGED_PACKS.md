...
1. Configure production public trust roots, catalog hosting, sequence/expiry publishing and key rotation/revocation. Complete the selected packs' redistribution materials before publishing their bytes. Keep private signing keys out of the repository, app and public artifacts.
