...
| Product website | Responsive site in the application theme, genuine screenshots, accurate feature/release claims and live deployment | Website and 22-demo gallery built from app theme tokens and reviewed synthetic captures; Pages workflow added |
| Release pipeline after source push | Verified initial push followed by reproducible CI/release/deploy workflows | Source checks, source preview release, Mac candidate qualification and Pages workflows added after e6c9221; first hosted results pending |
