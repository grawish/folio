...
![Folio keeps the current project open when another project's format is unsupported](../images/unsupported-project-format.png)
...
![ZIP import and main-document choice](../images/import.png)
...
![Restoring a saved source copy](../images/restore-file.png)
