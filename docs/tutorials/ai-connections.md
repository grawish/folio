...
![Codex connection form](../images/connection-codex.png)
...
![OpenAI key connection form](../images/connection-openai.png)

![Anthropic key connection form](../images/connection-anthropic.png)
