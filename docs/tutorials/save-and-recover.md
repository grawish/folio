...
![Choosing files after an interrupted save](../images/save-recovery.png)
...
![Recovery in a small light-theme window](../images/save-recovery-light.png)
