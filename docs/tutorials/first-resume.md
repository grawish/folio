...
The packaged smoke suite proves that the standalone Mac app compiles using its included resources. See [template evidence](../TEMPLATES.md) and the current release README. These automated checks are developer walkthroughs; a standalone public recording of this tutorial remains on the delivery checklist.
