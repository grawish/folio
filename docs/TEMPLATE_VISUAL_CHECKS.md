...
The Mac qualification workflow now runs this gate and retains its reports/images. The local result does not establish every macOS version, physical high-DPI display or accessibility behavior, and does not qualify a signed installer. Those remain separate release checks.
