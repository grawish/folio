...
| Qualify Apple silicon candidate | Manual | Fresh runtime setup, real compiler integration, arm64 packaging, eleven native suites (including compiler help and local fonts) and artifact verification |
