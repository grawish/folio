...
[Screenshot: Local font files with the real resume preview before saving](https://github.com/grawish/folio/blob/main/docs/images/local-fonts.png)
...
[Screenshot: The font preview in a small window with the light theme](https://github.com/grawish/folio/blob/main/docs/images/local-fonts-light.png)
...
If another app changes your project while you preview, Folio stops the save. Close the font screen, review the outside changes, then start a new preview. See [local font details and checks](https://github.com/grawish/folio/blob/main/docs/LOCAL_FONTS.md). `npm run test:fonts` reproduces the workflow with synthetic data and the real compiler.
