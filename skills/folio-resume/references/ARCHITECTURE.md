<!-- Generated from docs/ARCHITECTURE.md; run npm run skill:build after editing the guide. -->
...
See [harness measurements](https://github.com/grawish/folio/blob/main/docs/HARNESS_PERFORMANCE.md) for the synthetic benchmark and its limits.
